...
import com.berk.repository.CoinRepository;
...
public class CoinServiceImpl implements CoinService {
    ...
    public List<Coin> getCoinsList(int page) throws Exception {
        String url = "https://api.coingecko.com/api/v3/coins/markets?vs_currency=usd&per_page=10&page=" + page; // her sayfada 10 coin var 
    ...
    @Override
    public String getCoinInfo(String coinId) throws Exception {
        ...
        try {
            ...
            coin.setLow24h(marketData.get("high_24h").get("usd").asDouble());
    ...
    @Override
    public String searchCoin(String query) throws Exception {
    ...
    public String getTop50CoinsByMarketCap() throws Exception {
        String url = "https://api.coingecko.com/api/v3/coins/markets/vs_currency=usd&per_page=50&page=1"; // ilk 50 coin
    ...
    public String getTradingCoins() throws Exception {
        String url = "https://api.coingecko.com/api/v3/search/trading_view";
